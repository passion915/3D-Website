...
class Oss extends KrOperation
{
	...
	public function video_thumb($obj,$time){
		...
		$arr = array(
				...
				'SnapshotConfig' => '{"OutputFile": {"Bucket": "'.$GLOBALS['_lang']['oss_config']['bucket'].'","Location": "'.$GLOBALS['_lang']['oss_config']['location'].'","Object": "'.$thumb.'"},"Time": "'.($time*1000).'","FrameType":"normal"}'
			);
