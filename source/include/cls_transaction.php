...
class Transaction extends Common{
	...
	//根据位置获取广告
	public static function get_ad_by_postion($postion){
		return $GLOBALS['Db']->query("SELECT content FROM ".$GLOBALS['Base']->table('ad').' WHERE postion = '.$postion,'One');
	}
}
?>