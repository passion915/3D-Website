...
$("#publish_img").click(function(){
	...
	var tags = get_chose_tags("pic_chosen_chosen");
	params.pic_tags = tags.default;
	if (params.pic_tags.length==0) {
		showerr("请选择标签");
		return false;
	}
	params.custome_tags = tags.custom;
...
$("#publish_video").click(function(){
	...
	var tags = get_chose_tags("video_chosen");
	videoParams.video_tags = tags.default;
	if (videoParams.video_tags.length==0) {
		showerr("请选择标签");
		return false;
	}
	videoParams.custome_tags = tags.custom;
